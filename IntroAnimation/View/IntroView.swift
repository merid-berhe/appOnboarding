...
struct IntroView: View {
    ...
    func WalkThroughScreens()->some View{
        ...
        GeometryReader{
            ...
            // MARK: Next screen progress button
    ...
    func IntroScreen()->some View{
        GeometryReader{
            ...
            VStack(spacing: 10){
                ...
                Text("This is your companion app for Foum Events, virtual and in-person. Go through the on-boarding to make the most of what it offers")
                    .font(.custom(sansRegular, size: 14))
                    .multilineTextAlignment(.center)
                    .padding(.horizontal,30)
